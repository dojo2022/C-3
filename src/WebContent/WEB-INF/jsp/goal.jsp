...
<body>
	<header class="header">
		...
		<div>
			<a id='logout' href="/app/LogoutServlet" class="logoutbtn">ログアウト</a>
		</div>
			...
			<div class="tab_area">
				<form action="/app/GoalServlet" id="f0" method="POST">
					<input id="btn0" type="hidden" name="tag" value="0"> <label
						class="tab1_label" for="tab1" onclick="labelClick(this)">目標一覧</label>
				</form>
